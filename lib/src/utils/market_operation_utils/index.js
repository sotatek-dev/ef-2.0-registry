...
class MarketOperationUtils {
    ...
    createFillTest(opts) {
        return fills_1.createFills(opts);
    }
    findOptimalPathAsyncTest(side, fills, targetInput) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield path_optimizer_1.findOptimalPathAsync(side, fills, targetInput);
        });
    }
