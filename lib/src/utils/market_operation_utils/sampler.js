...
class DexOrderSampler extends sampler_operations_1.SamplerOperations {
    constructor(chainId, _samplerContract, _samplerOverrides, poolsCaches, tokenAdjacencyGraph, liquidityProviderRegistry, bancorServiceFn = () => __awaiter(this, void 0, void 0, function* () { return undefined; }), subgraphUrl = undefined) {
        super(chainId, _samplerContract, poolsCaches, tokenAdjacencyGraph, liquidityProviderRegistry, bancorServiceFn, subgraphUrl);
