...
import { NativeOrderWithFillableAmounts, RfqFirmQuoteValidator, RfqRequestOpts, SignedNativeOrder } from '../../types';
...
export declare type SourcesWithPoolsCache = ERC20BridgeSource.Balancer | ERC20BridgeSource.BalancerV2 | ERC20BridgeSource.Cream | ERC20BridgeSource.ABalancer | ERC20BridgeSource.RBalancer | ERC20BridgeSource.UBalancer;
/**
...
export interface GetMarketOrdersOpts {
    ...
    /**
     * balance of sell token on BSC
     */
    bscSellTokenBalance?: BigNumber;
    /**
     * balance of sell token on XLM
     */
...
export interface RawQuotes {
    ...
    xlmOrders?: SignedNativeOrder[];
    fcxOrders?: SignedNativeOrder[];
