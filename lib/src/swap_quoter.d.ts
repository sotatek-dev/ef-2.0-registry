...
import { FcxOrderBook } from './fcx/fcx_orderbook';
import { XlmOrderBook } from './fcx/xlm_orderbook';
import { MarketBuySwapQuote, MarketOperation, NativeOrderWithFillableAmounts, OrderPrunerPermittedFeeTypes, SignedNativeOrder, SwapQuote, SwapQuoteRequestOpts, SwapQuoterOpts } from './types';
import { DexSample, MarketDepth } from './utils/market_operation_utils/types';
...
export declare class SwapQuoter {
    ...
    readonly xlmOrderBook: XlmOrderBook;
    readonly fcxOrderBook: FcxOrderBook;
    ...
    swapTest(fcxOrder: NativeOrderWithFillableAmounts[], dexQuotes: DexSample[][], side: MarketOperation, targetInput: BigNumber): Promise<any>;
    /**
