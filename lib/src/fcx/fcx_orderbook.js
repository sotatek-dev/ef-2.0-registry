...
class FcxOrderBook {
    ...
    getOrdersAsync(makerToken, takerToken, options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const amountFeeRes = yield axios_1.default.get(`${this._fcxHost}/api/v1/ticker/fee-to-taker-amount`, {
                params: {
                    takerToken
                },
            });
            const feeAmount = (_a = amountFeeRes.data.data) !== null && _a !== void 0 ? _a : 0;
            const fcxOrders = [];
            for (let row of rows) {
                ...
                if (takerAmount.minus(feeAmount).lte(0)) {
                    continue;
                }
